-- Debug and Fix Search Functions for YardPass
...
-- ✅ DEBUG: Check if search functions exist and create them if missing
DO $$
BEGIN
    -- Check enhanced_search_v2 function
    IF NOT EXISTS (SELECT 1 FROM pg_proc WHERE proname = 'enhanced_search_v2') THEN
        ...
        -- Create simplified enhanced_search_v2 function
    ...
    -- Check get_search_suggestions function
    ...
    -- Check get_trending_searches function
    ...
    -- Check get_search_facets function
