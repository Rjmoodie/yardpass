-- Simple Final Solution: Remove Problematic View and Create Secure Alternative
-- This script avoids relation errors and provides a clean solution

-- ========================================
-- 1. SAFELY REMOVE THE PROBLEMATIC VIEW
-- ========================================

-- Drop the view if it exists (this won't error if it doesn't exist)
...
SELECT 
    'PROBLEMATIC VIEW STATUS' as section,
    CASE 
        WHEN EXISTS (
...
-- ========================================
SELECT 
    '🎯 Simple Final Solution Complete!' as status,
