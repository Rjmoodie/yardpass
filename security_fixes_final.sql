...
-- ========================================
-- 1. VERIFY RLS STATUS (All tables already have RLS enabled)
-- ========================================

-- All 47 tables already have RLS enabled - this is excellent!
-- Let's verify and optimize the existing policies

-- ========================================
-- 2. OPTIMIZE EXISTING RLS POLICIES
-- ========================================

-- Drop potentially conflicting policies and recreate optimized ones
-- Core User Tables
...
DROP POLICY IF EXISTS "Users can view event RSVPs" ON event_rsvps;
DROP POLICY IF EXISTS "Users can view event reviews" ON event_reviews;
DROP POLICY IF EXISTS "Users can view event posts" ON event_posts;
...
DROP POLICY IF EXISTS "Users can manage ticket transfers" ON ticket_transfers;
DROP POLICY IF EXISTS "Users can view ticket scans" ON ticket_scans;
DROP POLICY IF EXISTS "Users can view ticket tiers" ON ticket_tiers;
DROP POLICY IF EXISTS "Users can view tier badges" ON tier_badges;
DROP POLICY IF EXISTS "Users can view user event badges" ON user_event_badges;

-- Order Tables
DROP POLICY IF EXISTS "Users can view own orders" ON orders;
DROP POLICY IF EXISTS "Users can view order items" ON order_items;
DROP POLICY IF EXISTS "Users can view refunds" ON refunds;
DROP POLICY IF EXISTS "Users can view revenue tracking" ON revenue_tracking;
...
DROP POLICY IF EXISTS "Users can view content performance" ON content_performance;
DROP POLICY IF EXISTS "Users can view performance metrics" ON performance_metrics;
DROP POLICY IF EXISTS "Users can view creator dashboard widgets" ON creator_dashboard_widgets;
